...
class Quiz extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Quiz2(topic:"html intro",course:"html")
    );
  }
}
...
class Quiz1 extends State<Quiz2> {
  ...
  c=c.trim();
    ...
    QuerySnapshot qn = await firestore.collection('quiz-question')
        .where('coursename',isEqualTo:c).where('topic',isEqualTo:t).getDocuments();
                            ...
                            itemBuilder: (_, index) {
                              ...
                              return Container(
                                  child:Column(
                                    ...
                                    //op1= snapshot.data[index].data['option1']
