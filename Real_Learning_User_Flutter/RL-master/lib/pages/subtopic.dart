...
//qn = await firestore.collection('coursecontent').where('coursename',isEqualTo:'${this.cid}').getDocuments();
  ...
  Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) =>Quiz(topic:snapshot.data[index].data["topicname"],course :'${course.courseName}')//Topic(courseName :'${course.courseName}',courseDescription:snapshot.data[index].data[
                                      //"topicdescription"]),
